...
<div class="archive-company-wrap ">
    <p class="pan-list">
        ...
        > <span><?php single_cat_title(); ?>の施工事例一覧</span>


    </p>
</div>

<h2 class="category-h2">『<?php single_cat_title(); ?>』の施工事例一覧</h2>
...
<div class="tab_content-grid">
    ...
    $category = get_queried_object(); // 現在表示しているカテゴリーの情報を取得
    $args = array(
        'paged' => $paged,
        'posts_per_page' => 30, // 投稿を30件表示するように設定
        'orderby' => 'date', // 日付でソート
        'order' => 'DESC', // DESCで最新から表示、ASCで最古から表示
        'cat' => $category->term_id, // 現在表示しているカテゴリーのカテゴリーIDを使用
    );
