...
<head>
    ...
    <meta name="description" content="リフォームウォーカーに登録している業者の施工事例です。キッチン、トイレ、洗面台、リビング、玄関、お風呂などなどさまざまな場所をリフォームいたします！">
...
<body <?php body_class(); ?>>
    ...
    <!--ヘッダー-->
    <header>
        <p class="menseki">免責事項：当サイトはお客様と施工業者を仲介するサイトであり、お客様と業者間のトラブルに関していかなる場合も一切の責任を負い兼ねます。また、当サイトの利用により生じた損失や損害については、一切責任を負いません。 </p>
