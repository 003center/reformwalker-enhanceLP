    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <section class="single-construction-top">
            <?php if (CFS()->get("basyo") == "キッチン") : ?>
                ...
                <figure>
                    <img decoding="async" src="<?php echo get_template_directory_uri(); ?>/assets/img/reform-yane.jpg " alt="">
                    <figcaption>屋根リフォーム事例</figcaption>
                </figure>

                <?php elseif (CFS()->get("basyo") == "リビング") : ?>:
                <figure>
                    <img decoding="async" src="<?php echo get_template_directory_uri(); ?>/assets/img/reform-living.jpg " alt="">
                    <figcaption>リビングリフォーム事例</figcaption>
                </figure>

                <?php elseif (CFS()->get("basyo") == "和室") : ?>:
                <figure>
                    <img decoding="async" src="<?php echo get_template_directory_uri(); ?>/assets/img/reform-wasitsu.jpg " alt="">
                ...
                <figure>
                    <img decoding="async" src="<?php echo get_template_directory_uri(); ?>/assets/img/reform-sink.jpg " alt="">
